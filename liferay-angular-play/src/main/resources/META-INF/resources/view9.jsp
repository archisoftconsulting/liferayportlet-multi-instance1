...
<p>
	<b><liferay-ui:message key="liferay-angular-play.caption"/> 1.0.14</b>
</p>
...
<div id="<portlet:namespace/>Display">
    ...
    <h1>Users</h1>
    <div id="<portlet:namespace/>repeat" ng-repeat="user in users">
      <span>{{user.body.userId}}</span>
      <span>{{user.body.firstName}}</span>
      <span>{{user.body.lastName}}</span>
      <span>{{user.body.city}}</span>
